...
>
> Answer:
No, we didn't use branches, since we split tasks to work parallelly and the risk of causing conflicts are minimal. We have used pull requests to get everything up to date everytime before we picking up work on it.  
